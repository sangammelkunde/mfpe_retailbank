...
public class MvcController  {
	...
	public ModelAndView login(@ModelAttribute("login") AppUser user, HttpServletRequest request, Model model) throws CustomerNotFoundException {
		...
		try {
			...
			String dir = "";
			if (user.getRole().equalsIgnoreCase("EMP")) {
				dir = "employeelogin";
			} else {
				dir = "customerlogin";
			}
	...
	public ModelAndView withdraw(HttpServletRequest request) {
		...
		try {
			...
			return new ModelAndView("redirect:/customerdashboard?msg=Pppppppprovide correct Details or Minimum Balance is to be Maintained");
		}
	}
	...
	public ModelAndView transaction(HttpServletRequest request) {
		...
		try {
			...
			return new ModelAndView("redirect:/customerdashboard?transfermsg=done");
		} catch (Exception ex) {
			log.error("Error");
			System.err.println(ex);
			return new ModelAndView("redirect:/customerdashboard?transfermsg=Provide correct Details or Minimum Balance is to be Maintained");
		}
	}
