...
public class BankmvcApplication {
	...
	public Docket swaggerConfiguration() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.cognizant.bankmvc.controller")).build().apiInfo(apiInfo());
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("BankMVC Service", "Retail Banking Project", "API", "Terms of service",
